...
(function () {
  ...
  const EN = {
    ...
    'port.spot.label'     : 'EdTech · SaaS · Global',
    'port.spot.cs'        : 'MyEduTable — Global School Timetable Platform',
    'port.spot.desc'      : 'An international SaaS platform empowering schools and universities worldwide to build, manage, and optimize their academic timetables. Smart scheduling algorithms eliminate manual conflicts and reduce planning time by 70%.',
    'port.spot.s1'        : 'Schools Onboarded',
    'port.spot.s2'        : 'Languages Supported',
    'port.spot.s3'        : 'Available Globally',
    ...
    'port.f.all'          : 'All',
    'port.f.web'          : 'Web Dev',
    'port.f.ecommerce'    : 'E-Commerce',
    'port.f.management'   : 'Management Systems',
    'port.f.saas'         : 'SaaS Platforms',
    'port.f.ai'           : 'AI & Machine Learning',
    'port.p1.title'       : 'Masalek Al-Nour Charity Management System',
    'port.p1.desc'        : 'Integrated digital platform managing beneficiaries, donors, fundraising campaigns, and financial reporting for the charitable foundation',
    'port.p2.title'       : 'School Sessions Manager — Khula bint Al-Azwar',
    'port.p2.desc'        : 'Smart system for managing class schedules and sessions with dashboards for teachers and administrators to track attendance and performance',
    'port.p3.title'       : 'E-Commerce Store — Lava Perfumes & Gifts',
    'port.p3.desc'        : 'Full-featured e-commerce platform for luxury perfumes and gifts with inventory management, order tracking, and a seamless shopping experience',
    'port.p4.title'       : 'Global Luxury Fragrance Platform — Aromenza',
    'port.p4.desc'        : 'Premium e-commerce platform for Aromenza luxury fragrances featuring an elegant design that authentically reflects the brand identity with exceptional UX',
    'port.p5.title'       : 'Dental Clinic Management System — Denteam',
    'port.p5.desc'        : 'Comprehensive clinic management with online appointment booking, patient records, billing, and treatment plan tracking for the medical team',
    'port.p6.title'       : 'Global School Timetable Platform — MyEduTable',
    'port.p6.desc'        : 'International SaaS platform for managing academic timetables in schools and universities, with smart scheduling algorithms and multi-language support',
    'port.p7.title'       : 'Syrian Doctors Directory App — SYDR',
    'port.p7.desc'        : 'Mobile app and web directory of Syrian doctors in Syria, enabling patients to search by specialty, location, and rating, and book appointments online',
    'port.p8.title'       : 'Custom Face Recognition Model — CNN',
    'port.p8.desc'        : 'Training a custom Convolutional Neural Network (CNN) model for high-accuracy face recognition, including data preprocessing, augmentation, and hyperparameter tuning',
    'port.p9.title'       : 'Corporate Website — Etta Systems',
    'port.p9.desc'        : 'Professional corporate website for Etta Systems with a modern design reflecting the brand identity, high performance, and a smooth user experience',
    ...
    'contact.map'         : 'Damascus — Al-Malki',
    'contact.c3.label'    : 'Headquarters',
    'contact.c3.value'    : 'Damascus — Al-Malki, Syria',
    'contact.c3.sub'      : 'We work with clients across the Arab world and beyond',
    'contact.c4.label'    : 'Turkey Office',
    'contact.c4.value'    : 'Istanbul — Fatih, Turkey',
    'contact.c4.sub'      : 'Serving clients in Turkey and Europe',
    'contact.c5.label'    : 'Oman Office',
    'contact.c5.value'    : 'Barka — Sultanate of Oman',
    'contact.c5.sub'      : 'Serving clients across the Gulf region',
    ...
    'contact.faq.a1'      : 'We respond to all messages within 24 business hours. Send your message through the form below and our team will get back to you as soon as possible.',
    ...
    'contact.faq.a4'      : 'You can send a message anytime through the form and we\'ll reach out at the earliest opportunity. For emergency support on ongoing projects, we have a 24/7 support line available to our current clients.',
